...
class AgentFactory:
    ...
    def create_agent(self, t):
        ...
        if created:
            # Se pueden crear diferentes combinaciones, para que varien las probabilidades
            # de tener vacuna o ser infectado, en este caso he considerado que nunca coincidan
            # las 2 situaciones y utilizo el ratio de infeccion como parametro de control
            vacune = True if (random.random()) > (self.infected_rate*6) else False
            infected = True if random.random()*1.5 < self.infected_rate else False
