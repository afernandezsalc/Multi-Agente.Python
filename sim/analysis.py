...
plot_experiment("time_req_waiting_area", "data1.csv")
plot_experiment("creation_rate", "data1.csv")
plot_experiment("average_transmissions", "data1.csv")
plot_experiment("transmission_rate", "data1.csv")
